...
![A screenshot of `umd0.cpk` opened in CriFsLib GUI](../../../../../assets/p3p/getting-started/extracting-files/crifs-extract-all.png)
...
![A screenshot of `init_free.bin` opened in Amicitia ](../../../../../assets/p3p/getting-started/extracting-files/amicitia.png)
...
![A screenshot of `init_free.bin` opened in Prsona Editor](../../../../../assets/p3p/getting-started/extracting-files/persona-editor.png)
...
![](../../../../../assets/p3p/getting-started/extracting-files/pak-unpack-context.png)
