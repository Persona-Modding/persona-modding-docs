...
![A screenshot of the manage mods tab in Reloaded with the New button highlighted](../../../../../assets/p3p/getting-started/making-a-mod/new-mod.png)
...
![A screenshot of the dialog for entering basic details of a new mod in Reloaded](../../../../../assets/p3p/getting-started/making-a-mod/new-mod-details.png)
...
![A screenshot of the dialog for setting mod dependencies in Reloaded, with Persona Essentials selected (with a red cross next to it)](../../../../../assets/p3p/getting-started/making-a-mod/new-mod-dependencies.png)
