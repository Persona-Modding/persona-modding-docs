...
description: How to add modded files into a Persona 3 FES (PS2) mod.
prev: true
next: true
sidebar:
  order: 2
...
<FileTree>
  - p3ppc.test.myMod - ModConfig.json Automatically managed by Reloaded -
  P5REssentials - CPK - umd0.cpk - camp - bustup - **c_cha05a.tmx**
</FileTree>
...
<FileTree>
  - p3ppc.test.myMod - ModConfig.json Automatically managed by Reloaded -
  FEmulator - PAK - init_2.bin - camp - bustup - **c_cha01a.tmx**
</FileTree>
