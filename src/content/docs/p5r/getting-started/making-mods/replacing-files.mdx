...
description: How to add modded files into a Persona 5 Royal (PC) mod.
prev: true
next: true
sidebar:
  order: 2
...
<FileTree>
  - p4g64.test.myMod - ModConfig.json Automatically managed by Reloaded-II -
  P5REssentials - CPK - data.cpk/
</FileTree>
...
<FileTree>
  - p4g64.test.myMod - ModConfig.json Automatically managed by Reloaded-II -
  P5REssentials - CPK - data.cpk - camp - bustup - **c_cha01a.tmx**
</FileTree>
...
<FileTree>
  - p4gpc.test.myMod - ModConfig.json Automatically managed by Reloaded-II -
  FEmulator - PAK - bustup - b2_1_3.bin - **b2_1_3.tmx** - **m2_1_3.tmx**
</FileTree>
