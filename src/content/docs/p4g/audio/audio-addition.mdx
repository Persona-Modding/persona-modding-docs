...
description: How to add brand new audio files in Persona 4 Golden (PC).
prev: true
next: true
sidebar:
  order: 13
...
<Aside>Add information for new voice lines and sound effects</Aside>
...
![](../../../../assets/p3p/audio/phosnewtrack.png)
...
![](../../../../assets/p3p/audio/phosaddtrack.png)
